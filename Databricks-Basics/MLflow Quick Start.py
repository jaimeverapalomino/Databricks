...
# MAGIC %md
# MAGIC Instalaremos las librerias en la sesion del Notebook
...
dbutils.library.installPyPI("matplotlib",version="2.2.2")
...
def train_diabetes(data, in_alpha, in_l1_ratio):
  ...
  with mlflow.start_run():
    ...
    modelpath = "/dbfs/mlflow/test_induccion/model-%f-%f" % (alpha, l1_ratio)
...
# MAGIC %fs rm -r dbfs:/mlflow/test_induccion
...
# MAGIC %fs ls dbfs:/mlflow/test_induccion/
...
# MAGIC %md
# MAGIC vamos a ver donde guarda la data de tracking (equiv runs), en este caso no usamos tracking server luego se guara en DBFS
...
display(dbutils.fs.ls("dbfs:/mlflow/test_induccion/"))
